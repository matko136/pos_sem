...
unsigned long long int modularPow(unsigned long long int prvy, unsigned long long int druhy, unsigned long long int mod) {
    unsigned long long int result = 1;
    prvy = prvy % mod;
    if(prvy == 0)
        return 0;
...
bool millerRabinTestIteration(unsigned long long int divisionByTwo, unsigned long long int tester,unsigned long long int d, unsigned long long int possiblePrime) {
...
unsigned long long int genPrime() {
    ...
    unsigned long long int prime = (powLint(2,nBit-1)+1) + rand()%((powLint(2,nBit)-powLint(2,nBit-1)-1));
    bool isPrime = false;
    while (!isPrime) {
